...
Results
```
A 100 times repetition of this permutated paired t-test shows that no p-value falls over the choosen alpha-value of 0.05. I also calculated descriptive statistics for the distribution. The distribution looks almost normal (repeating the loop more often would have improved this). 
