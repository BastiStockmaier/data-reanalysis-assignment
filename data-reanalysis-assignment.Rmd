...
## Past donor experiment analysis
...
```{r}
Results.paper<-c(15, 12,91,0.0014,0.005)
My.results<-c(length(donors$duration),ci$normal[2], ci$normal[3],p,pw$p.value)
Compare<-rbind(Results.paper, My.results)
colnames(Compare)<-c("N", "lower CI", "upper CI", "permuted.p", "Wilcox.p")
Compare
```
